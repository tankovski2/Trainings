...
using BuildMyOwnFramework.Infrastructure.Alerts;
using BuildMyOwnFramework.Models.Issue;
using BuildMyOwnFramework.Controllers;

namespace FailTracker.Web.Controllers
{
    public class IssueController : BuildMyOwnFrameworkController
    {
